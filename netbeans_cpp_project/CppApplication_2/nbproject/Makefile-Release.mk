...
LDLIBSOPTIONS=-Ldist/Debug/Cygwin-Windows
...
${OBJECTDIR}/Odun.o: Odun.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Odun.o Odun.cpp
